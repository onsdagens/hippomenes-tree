...
#
# arbitration-tree.tcl: Tcl script for re-creating project 'arbitration-tree'
#
# Generated by Vivado on Thu Nov 21 15:04:19 CET 2024
...
#
# 1. This project restoration tcl script (arbitration-tree.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/pawel/arbitration-tree/vivado/ARTY.xdc"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/pawel/arbitration-tree/hdl/vivado/ip/clk_wiz_0/clk_wiz_0.xci"
#    "/home/pawel/arbitration-tree/hdl/tree.sv"
#    "/home/pawel/arbitration-tree/hdl/fpga_tree.sv"
#    "/home/pawel/arbitration-tree/hdl/sim_tree.sv"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado/ARTY.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/hdl/vivado/ip/clk_wiz_0/clk_wiz_0.xci"]"\
 "[file normalize "$origin_dir/hdl/tree.sv"]"\
 "[file normalize "$origin_dir/hdl/fpga_tree.sv"]"\
 "[file normalize "$origin_dir/hdl/sim_tree.sv"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "arbitration-tree"
...
set script_file "arbitration-tree.tcl"
...
set_msg_config  -id {filemgmt 56-199}  -suppress  -ruleid {1}  -source 16
set_msg_config  -severity {WARNING}  -suppress  -ruleid {10}  -source 2
set_msg_config  -severity {CRITICAL WARNING}  -suppress  -ruleid {11}  -source 2
set_msg_config  -id {Synth 8-7080}  -string {{WARNING: [Synth 8-7080] Parallel synthesis criteria is not met}}  -suppress  -ruleid {2}  -source 8
set_msg_config  -severity {STATUS}  -suppress  -ruleid {8}  -source 2
set_msg_config  -severity {INFO}  -suppress  -ruleid {9}  -source 2
...
set file "$origin_dir/hdl/vivado/ip/clk_wiz_0/clk_wiz_0.xci"
...
set file "$origin_dir/hdl/tree.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/hdl/fpga_tree.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "top" -value "fpga_tree" -objects $obj
...
set file "[file normalize "$origin_dir/vivado/ARTY.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "vivado/ARTY.xdc"
...
set file "$origin_dir/hdl/sim_tree.sv"
set file [file normalize $file]
...
set_property -name "top" -value "sim_tree" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/arbitration-tree.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/arbitration-tree.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/arbitration-tree.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
